...
def run_test_doubler():
    ...
    # -------------------------------------------------------------------------
    arg1 = [0, -23, 24, 7, -245, 0, 4, 7, 253]
    arg2 = [34, 42, 6, 1, 7, 4, -76]
    correct_arg1_after = [0, -46, 48, 14, -490, 0, 8, 14, 506]
    correct_arg2_after = [34, 42, 6, 1, 7, 4, -76]
    expected = [68, 84, 12, 2, 14, 8, -152]
